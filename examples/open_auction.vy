...
# Withdraw a previously refunded bid. The withdraw pattern
# is used here to avoid a security issue. If refunds were
# directly sent as part of bid(), a malicious bidding
# contract could block those refunds and thus block new
...
def endAuction():
  ...
  # interact with other contracts (i.e. call functions or
  # send Ether) into three phases:
  ...
  # times. If functions called internally include interaction
  # with external contracts, they also have to be considered
